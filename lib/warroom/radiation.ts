...
// Elevated readings are anything above this threshold
export const ELEVATED_THRESHOLD = 100;
...
export async function fetchSafecastData(): Promise<RadiationReading[]> {
...
export const SEED_READINGS: RadiationReading[] = [
