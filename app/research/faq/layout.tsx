...
const faqItems = [
  ...
  { q: "What subscription tiers are available?", a: "Three tiers: Analyst ($150/month), Operator ($450/month), and Institution (custom pricing). All new accounts start with a free trial of 5,000 credits." },
